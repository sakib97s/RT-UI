...
@Component({
  selector: 'app-header-cart-4',
  templateUrl: './header-cart-4.component.html',
  styleUrl: './header-cart-4.component.scss',
  imports: [
    RouterLink,
    NgClass,
    ProductPricePipe,
...
export class HeaderCart4Component implements OnInit, OnDestroy {
