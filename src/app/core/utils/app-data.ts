...
const cdn = ['16px', '48px', '96px', '128px', '384px', '640px', '750px', '828px', '1080px', '1200px', '1342px', '1920px', '2048px']


export const CART_MAX_CAPACITY: number = 10;
export const CART_MAX_QUANTITY: number = 10000;
export const ADDRESS_MAX_CAPACITY: number = 3;
export const MAX_IMAGE_UPLOAD: number = 3;

export const PAYMENT_METHODS = [

  {
    name: 'Binance',
    image: 'https://cdn.saleecom.com/upload/static/binance.png',
    providerName: 'Binance',
    country: 'Bangladesh'
  },
  {
    name: 'Nagad',
    image: 'https://cdn.saleecom.com/upload/static/nagad_logo_200px.png',
    providerName: 'Nagad',
    country: 'Bangladesh'
  },
  {
    name: 'Rocket',
    image: 'https://cdn.saleecom.com/upload/static/rocket_200px.png',
    providerName: 'Rocket',
    country: 'Bangladesh'
  },
  {
    name: 'Pay with Online',
    image: 'https://cdn.saleecom.com/upload/static/sslcommerz_logo_200px.png',
    providerName: 'SSl Commerz',
    country: 'Bangladesh'
  },
  {
    name: 'Upay',
    image: 'https://cdn.saleecom.com/upload/static/upay.png',
    providerName: 'Upay',
    country: 'Bangladesh'
  },
  {
    name: 'Pay with Online',
    image: 'https://cdn.saleecom.com/upload/images/67a8615b53a1da782b9acad9/stripe-payment-dd32.webp',
    providerName: 'Stripe',
    country: 'International'
  },
  {
    name: 'Pay Station',
    image: 'https://cdn.saleecom.com/upload/static/paystation-24.png',
    providerName: 'PayStation',
    country: 'Bangladesh'
  },
  {
    name: 'EPS',
    image: 'https://cdn.saleecom.com/upload/static/credit-cards.jpeg',
    providerName: 'EPS',
    country: 'Bangladesh'
  },
  {
    name: 'Zini Pay',
    image: 'https://cdn.saleecom.com/upload/static/zinipay.png',
    providerName: 'ZiniPay',
    country: 'Bangladesh'
  },
  {
    name: 'Shurjo Pay',
    image: 'https://cdn.saleecom.com/upload/static/shurjopay.png',
    providerName: 'ShurjoPay',
    country: 'Bangladesh'
  },

];

export const ADDRESS_TYPES: Select[] = [
  { value: 'home', viewValue: 'Home' },
  { value: 'office', viewValue: 'Office' },
  { value: 'hometown', viewValue: 'Hometown' },
]
//maruf
